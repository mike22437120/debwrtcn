...
DEBWRT_KERNEL_HEADERS_VERSION:=2.6.32.14

debian/package/debwrt-kernel-headers: debian/package/debwrt-kernel-headers/deliver
	touch $@
...
debian/package/debwrt-kernel-headers/prepare: debian/buildenv/create
	...
	if [ -f $(INSTALL_DIR)/$(HEADERS_TAR_GZ) ]; then \
		...
		cp $(DEBIAN_PACKAGES_DIR)/debwrt-kernel-headers/debwrt-headers-*.tar.gz $(DEBIAN_BUILD_DIR)/usr/src/debwrt-kernel-headers; \
	fi
	touch $@
